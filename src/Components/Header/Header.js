      ...
      <div className="flex flex-row justify-start items-center gap-8 pt-5">
        ...
        {userInfo?.isLoggedIn && userInfo?.photoURL && (
          <div className="flex gap-10">
            ...
            <div className="flex flex-col justify-center items-center hover:underline cursor-pointer" onClick={currentUserClickHandler}>
              <div
